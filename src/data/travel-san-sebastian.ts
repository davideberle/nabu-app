...
export const categories: TravelCategory[] = [
  // ===== FINAL DAYS (Mon 20 – Fri 24 July) =====
  {
    id: "final-days",
    name: "Final days",
    emoji: "📅",
    description:
      "The remaining plan, Mon 20 – Fri 24 July. Return flight from Bilbao is Fri 24 at 15:45. AEMET (checked 2026-07-19): Mon–Thu dry, highs ~27–28 °C; rain risk rises Friday. Details for each named place live under Food and Small adventures.",
    items: [
      {
        id: "final-mon-20",
        label: "Mon 20 — home reset day",
        categoryTag: "Rest day",
        note: "Intentionally light: calls, home, pool and beach. No fixed plans — recover before the final stretch. Dry, ~27–28 °C.",
        tags: ["home", "beach", "rest", "planned"],
      },
      {
        id: "final-tue-21",
        label: "Tue 21 — Bodegón Alejandro lunch (proposed)",
        categoryTag: "Lunch",
        hours: "Around 13:15–13:30 seating",
        note: "One optional extra lunch: Bodegón Alejandro in the old town, ~55 EUR menu reference. Subject to availability — not booked. See Food › Bodegón Alejandro.",
        tags: ["lunch", "old-town", "proposed", "not-booked"],
        mapUrl: "https://www.google.com/maps/search/Bodegon+Alejandro+Calle+Fermin+Calbeton+4+San+Sebastian",
      },
      {
        id: "final-wed-22",
        label: "Wed 22 — Chillida Leku + Parte Vieja pintxos",
        categoryTag: "Excursion + dinner",
        note: "Small excursion to Chillida Leku after the 15:00 pickup (~15:45–18:30, closed Tuesdays but open Wed), then a proper family Parte Vieja pintxos crawl for dinner. See Small adventures › Chillida Leku and Food › Parte Vieja pintxos crawl.",
        tags: ["excursion", "pintxos", "family", "planned"],
      },
      {
        id: "final-thu-23",
        label: "Thu 23 — Atari lunch + Sirimiri farewell dinner",
        categoryTag: "Fixed anchors",
        note: "Fixed anchors: lunch at Atari Gastroteka (Calle Mayor 18, Parte Vieja) and the final trip dinner at Sirimiri (Calle Mayor 4, Parte Vieja). Both planned. See Food › Atari Gastroteka and Food › Sirimiri.",
        tags: ["lunch", "dinner", "old-town", "planned", "anchor"],
      },
      {
        id: "final-fri-24",
        label: "Fri 24 — departure",
        categoryTag: "Travel",
        note: "Departure only. Return flight from Bilbao 15:45 — no restaurant lunch planned. Rain risk rises today, so leave buffer for the ~1h drive to Bilbao airport.",
        tags: ["travel", "departure", "planned"],
      },
    ],
  },
  ...
  // ===== 1. FOOD =====
  {
    ...
    items: [
      ...
      // --- Casual / family weeknight options ---
      {
        ...
        distanceFromHomeKm: 3.5,
        mapUrl: "https://www.google.com/maps/search/Bodegon+Alejandro+Calle+Fermin+Calbeton+4+San+Sebastian",
        note: "Family-run in the old town, Calle Fermín Calbetón 4. Modern Basque with seasonal focus; current tourism reference ~55 EUR menu. The one optional remaining extra lunch — proposed for Tue 21 around 13:15/13:30. Subject to availability, not booked.",
        tags: ["modern", "old-town", "family-friendly", "proposed"],
        sourceTags: ["Michelin"],
        booking: "Subject to availability — not booked",
      },
      {
        id: "la-fabrica",
        label: "La Fábrica",
      ...
      {
        id: "atari-gastroteka",
        label: "Atari Gastroteka",
        cuisine: "Modern pintxos / casual Basque",
        hours: "Daily, kitchen ~12:00–23:30; check current hours",
        price: "$$",
        googleRating: 4.3,
        distanceFromHomeKm: 3.5,
        mapUrl: "https://www.google.com/maps/search/Atari+Gastroteka+Calle+Mayor+18+San+Sebastian",
        note: "Calle Mayor 18, Parte Vieja, beside Santa María church. Casual modern pintxos and plates with a lively terrace. Thu 23 lunch anchor (planned).",
        tags: ["pintxos", "modern", "old-town", "family-friendly", "planned"],
        booking: "Walk-in; reserve terrace if convenient",
      },
      {
        id: "sirimiri",
        label: "Sirimiri",
        ...
        googleRating: 4.4,
        distanceFromHomeKm: 3.5,
        mapUrl: "https://www.google.com/maps/search/Sirimiri+Calle+Mayor+4+San+Sebastian",
        note: "Calle Mayor 4, Parte Vieja (corrected — not Antiguo). Casual Basque fare. Thu 23 final trip dinner (planned).",
        tags: ["old-town", "casual", "family-friendly", "planned"],
    ...
    items: [
      {
        id: "chillida-leku",
        label: "Chillida Leku",
        hours: "Daily 10:00–19:00; closed Tuesday. Free visitor parking.",
        categoryTag: "Museum",
        distanceFromHomeKm: 8,
        mapUrl: "https://www.google.com/maps/search/Chillida+Leku+Hernani",
        websiteUrl: "https://www.museochillidaleku.com/en/visit-us/practical-information/",
        sourceUrl: "https://www.museochillidaleku.com/en/visit-us/practical-information/",
        sourceLabel: "Museo Chillida Leku (official)",
        note: "Eduardo Chillida's open-air sculpture park around the Zabalaga farmhouse in Hernani. The one remaining small excursion: Wed 22 after the 15:00 pickup, roughly 15:45–18:30. Open 10:00–19:00 except Tuesday; free on-site parking.",
        tags: ["sunny", "family", "culture", "planned"],
      },
      {
        id: "aquarium",
