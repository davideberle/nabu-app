    ...
    items: [
      {
        ...
        note: "Haro Barrio de la Estacion bodegas + Laguardia medieval town or Briones/Vivanco museum. ~1.5h drive each way.",
        tags: ["wine", "adults", "sunny"],
        sourceTags: ["Lonely Planet"],
        booking: "Book winery visits ahead",
        subItems: [
          {
            id: "rioja-haro-bodegas",
            label: "Haro – Barrio de la Estación",
            note: "Historic winery district: López de Heredia, Muga, CVNE, Roda. Walk between cellars. Book 1–2 wineries.",
            tags: ["wine", "booking"],
            mapUrl: "https://www.google.com/maps/search/Barrio+de+la+Estacion+Haro",
          },
          {
            id: "rioja-laguardia",
            label: "Laguardia",
            note: "Fortified medieval hilltop village. Underground cellars. Beautiful views over vineyards.",
            tags: ["culture", "views"],
            mapUrl: "https://www.google.com/maps/search/Laguardia+Rioja+Alavesa",
          },
          {
            id: "rioja-vivanco",
            label: "Vivanco Museum of Wine Culture (Briones)",
            note: "World-class wine museum. Interactive, excellent for context before the tastings.",
            tags: ["culture"],
            mapUrl: "https://www.google.com/maps/search/Vivanco+Museum+Briones",
            websiteUrl: "https://vivancoculturadevino.es",
          },
          {
            id: "rioja-hector-oribe",
            label: "Héctor Oribe (Paganos)",
            note: "Michelin-starred restaurant in Rioja Alavesa. Refined Riojan cooking. Worth booking for a special lunch.",
            cuisine: "Riojan",
            michelin: "1 Star",
            price: "$$$$",
            tags: ["food", "michelin", "booking"],
            mapUrl: "https://www.google.com/maps/search/Hector+Oribe+Paganos",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        note: "Guggenheim museum + Casco Viejo pintxos. ~1h drive. Book museum tickets online to skip queues.",
        tags: ["culture", "rainy", "family"],
        sourceTags: ["Lonely Planet", "TripAdvisor Top"],
        booking: "Book Guggenheim tickets online",
        subItems: [
          {
            id: "bilbao-guggenheim-museum",
            label: "Guggenheim Museum",
            note: "Gehry's iconic building. Allow 2–3 hours. Kids enjoy the spider sculpture and ground-floor installations.",
            tags: ["culture", "rainy", "family"],
            mapUrl: "https://www.google.com/maps/search/Guggenheim+Bilbao",
            websiteUrl: "https://www.guggenheim-bilbao.eus",
          },
          {
            ...
            label: "Casco Viejo (old town)",
            note: "Siete Calles, Ribera market, Plaza Nueva pintxos. Good walk after the museum.",
          ...
          },
          {
            id: "bilbao-mina",
            label: "Mina (Bilbao)",
            note: "One Michelin star. Inventive small-plate format on the riverfront. Elevated lunch stop.",
            cuisine: "Modern Basque",
            michelin: "1 Star",
            price: "$$$$",
            tags: ["food", "michelin", "booking"],
